...
class BaseParserTest {
    ...
    private final Splitter splitter = new Splitter.Base();

    private final Converter converter = new Converter.Base(Arrays.asList(
    ...
    @Test
    void parse_nextline() {
        final Parser parser = new Parser.Base("\n", splitter, converter);
    ...
    void parse_semicolon() {
        final Parser parser = new Parser.Base(";", splitter, converter);
